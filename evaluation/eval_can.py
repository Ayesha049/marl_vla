#!/usr/bin/env python
"""
Generic evaluation script for can task that works across different machines and directories.
Usage: python eval_can.py [--epoch EPOCH] [--n_rollouts N] [--horizon H] [--seed SEED]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='Evaluate trained can policy',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog='Examples:\n'
               '  python eval_can.py\n'
               '  python eval_can.py --epoch 600 --n_rollouts 50\n'
               '  python eval_can.py --seed 42'
    )
