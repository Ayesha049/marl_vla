#!/usr/bin/env python
"""
Evaluate can policy robustness with action noise and record videos.

Tests noise levels: [0.1, 0.2, 0.5, 1.0]
Records video for first rollout of each noise level.

Usage: python eval_robustness_can_video.py --epoch 600 --n_rollouts 10
"""
